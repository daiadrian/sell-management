...
<div style="padding:10px 10px 10px 10px">
	<form id="stockEditForm" class="itemForm" method="post">
...
<script type="text/javascript">
	function submitForm(){
		...
		$("#stockEditForm [name=price]").val(eval($("#stockEditForm [name=priceView]").val()) * 100);

		$.post("/stock/rest/update",$("#stockEditForm").serialize(), function(data){
			if(data.status == 200){
				$.messager.alert('提示','修改记录成功!','info',function(){
					$("#stockEditWindow").window('close');
